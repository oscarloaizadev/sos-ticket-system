...
<head>
  ...
  <link rel="stylesheet" href="<?= urlRedirect('/public/lib/bootstrap/css/bootstrap.css?v=10') ?>">
  ...
  <link rel="stylesheet" href="<?= urlRedirect('/public/assets/css/styles.css?v=10') ?>">

  <!-- Scripts personalizados -->
  <script src="<?= urlRedirect('/public/assets/js/app.js') ?>" type="module"></script>
